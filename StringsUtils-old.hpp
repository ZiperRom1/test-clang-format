    ...
    class StringsUtils {
        public:
            ...
            static QString fromLatin1ToAscii(const QString& s) {
                static QStringList diacriticLetters_{
                    "Š", "Œ", "Ž", "š", "œ", "ž", "Ÿ", "¥", "µ", "À", "Á", "Â", "Ã", "Ä", "Å", "Æ", "Ç", "È", "É", "Ê", "Ë", "Ì", "Í",
                    "Î", "Ï", "Ð", "Ñ", "Ò", "Ó", "Ô", "Õ", "Ö", "Ø", "Ù", "Ú", "Û", "Ü", "Ý", "ß", "à", "á", "â", "ã", "ä", "å", "æ",
                    "ç", "è", "é", "ê", "ë", "ì", "í", "î", "ï", "ð", "ñ", "ò", "ó", "ô", "õ", "ö", "ø", "ù", "ú", "û", "ü", "ý", "ÿ"};
                static QStringList noDiacriticLetters_{"S",  "OE", "Z", "s", "oe", "z", "Y", "Y", "u", "A", "A", "A", "A", "A", "A",
                                                       "AE", "C",  "E", "E", "E",  "E", "I", "I", "I", "I", "D", "N", "O", "O", "O",
                                                       "O",  "O",  "O", "U", "U",  "U", "U", "Y", "s", "a", "a", "a", "a", "a", "a",
                                                       "ae", "c",  "e", "e", "e",  "e", "i", "i", "i", "i", "o", "n", "o", "o", "o",
                                                       "o",  "o",  "o", "u", "u",  "u", "u", "y", "y", " ", " ", " "};
            ...
            /**
             * Formate en string un montant en euro en ne gardant que deux décimales et en gérant les arrondis (arrondi supérieur en
             * absolu)" / ! \ Maximum 11 chiffres pour la valeur d'entrée
